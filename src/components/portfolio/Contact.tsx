...
import { Send, Check, Mail, Github, Linkedin, Download, MapPin, FileText } from "lucide-react";
...
export function Contact() {
  ...
  return (
    <Section
      id="contact"
      eyebrow="// contact"
      title={<>Let's build something <span className="text-gradient-static">great</span>.</>}
        ...
        >
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <div className="font-mono text-sm truncate">saumya122004@gmail.com</div>
            </div>
          </a>
          <a
...
>
  <div>
    ...
    <p className="mt-4 max-w-2xl text-muted-foreground leading-relaxed">
      ...
      from competitive programming and low-level optimization
      to scalable backend architectures and distributed systems.
      Always open to impactful opportunities, collaborations,
      and ambitious ideas.
    </p>
  </div>
